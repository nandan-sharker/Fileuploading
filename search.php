...
<div class="container">
	...
	<div class="page-header">
     	<marquee><h1>Search All data!!!</h1></marquee>
            ...
            $query = $DB_con->prepare("SELECT * FROM users WHERE std_id like '%" . $search . "%' OR name like '%" . $search . "%' OR Address like '%" . $search . "%' OR email like '%" . $search . "%' OR mobile like '%" . $search . "%'");


            // var_dump($query);

            while($arr=$query->fetch(PDO::FETCH_ASSOC) > 0){ ?>
